        ...
        <div className={styles.content}>
          ...
          <div className={styles.state_prof}>
            <p>
              ...
              delectus soluta optio harum accusamus labore, praesentium facere
              eum laborum, perspiciatis deleniti voluptates vero placeat quam,
              autem itaque doloribus laboriosam recusandae.
            </p>
          </div>
